...
<body>
  ...
  <DIV class='title_line'>
    ...
    <A href="../cate/list_join_by_categrpno">${categrpVO.name } (${categrpVO.rdate.substring(0, 10) })</A>
  </DIV>
      ...
      <TD class="td_bs">
        <c:choose>
          <c:when test="${visible == 'Y'}">
            <A href="./update_visible?cateno=${cateno }&visible=${visible }&categrpno=${categrpno}"><IMG src="./images/open.png"></A>
          </c:when>
          <c:otherwise>
            <A href="./update_visible?cateno=${cateno }&visible=${visible }&categrpno=${categrpno}"><IMG src="./images/close.png"></A>
          </c:otherwise>
        </c:choose>
      </TD>
